...
export class GoodsReceiptDetailRepository extends Repository {
  ...
  send = (goodsReceiptPOEntity: GoodsReceipt): Observable<GoodsReceipt> => {
    return this.http.post<GoodsReceipt>(
      this.apiUrl + '/send',
  ...
  singleListPurchaseOrder = (purchaseOrderOfGoodsReceiptSearch: PurchaseOrderOfGoodsReceiptSearch):
    Observable<PurchaseOrderOfGoodsReceipt[]> => {
    return this.http.post<PurchaseOrderOfGoodsReceipt[]>(
        ...
        map(
          r => {
            return r.body.map((item) => {
              return new PurchaseOrderOfGoodsReceipt(item);
            });
          },
        ),
      );
  ...
  singleListSupplier = (supplierDetailOfGoodsReceiptSearch: SupplierDetailOfGoodsReceiptSearch):
    ...
    return this.http.post<SupplierDetailOfGoodsReceipt[]>(
  ...
  singleListSupplierContact = (supplierContactOfGoodsReceiptSearch: SupplierContactOfGoodsReceiptSearch):
    ...
    return this.http.post<SupplierContactOfGoodsReceipt[]>(
  ...
  singleListItemDetail = (itemDetailOfGoodsReceiptSearch: ItemDetailOfGoodsReceiptSearch): Observable<ItemDetailOfGoodsReceipt[]> => {
    return this.http.post<ItemDetailOfGoodsReceipt[]>(
  ...
  singleListUnitOfMeasure = (unitOfMeasureOfGoodsReceiptSearch: UnitOfMeasureOfGoodsReceiptSearch): Observable<UnitOfMeasureOfGoodsReceipt[]> => {
    return this.http.post<UnitOfMeasureOfGoodsReceipt[]>(
  ...
  singleListTax = (taxOfGoodsReceiptSearch: TaxOfGoodsReceiptSearch): Observable<TaxOfGoodsReceipt[]> => {
    return this.http.post<TaxOfGoodsReceipt[]>(
  ...
  combineGoodsReceiptPO = (data: any) => {
    return this.http.post<GoodsReceipt>(
      this.apiUrl + '/combine-goods-receipt-po-content',
      data,
      {
        observe: 'response',
        headers: this.getHeader(),
      ...
      .pipe(
        map(
          (response: HttpResponse<GoodsReceipt>) => new GoodsReceipt(response.body),
        ),
      );
  };
