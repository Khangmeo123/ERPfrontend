...
import { GoodsIssueSendService } from './goods-issue-send.service';
import { GeneralService } from 'src/app/_services/general-service.service';
import { GoodsIssueSendRepository } from './goods-issue-send.repository';
import {
...
@Component({
  ...
  templateUrl: './goods-issue-send.component.html',
  styleUrls: ['./goods-issue-send.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [GoodsIssueSendService]
})
export class GoodsIssueSendComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private goodsIssueDetailService: GoodsIssueSendService,
    private activatedRoute: ActivatedRoute,
    private goodsIssueDetailRepository: GoodsIssueSendRepository,
