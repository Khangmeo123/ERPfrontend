...
export class DeliveryOrderForm extends FormModel {
    ...
    DeliveryOrderContents = new FormArray([]);
    freight = new FormControl(null);
    packageDimension = new FormControl(null);
    packageWeight = new FormControl(null);

    constructor(DeliveryOrderEntity?: any) {
        super();
        this.mapData(DeliveryOrderEntity);
    }
}