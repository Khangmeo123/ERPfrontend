...
export class EmployeePositionService {
  ...
  getList(employeePositionSearchEntity: EmployeePositionSearchEntity): Promise<boolean> {
    return new Promise<boolean>((resolve, reject) => {
      forkJoin(
        this.employeePositionRepository.getListEmployeePosition(employeePositionSearchEntity),
        this.employeePositionRepository.countEmployeePosition(employeePositionSearchEntity),
      )
        .subscribe(
          ([list, count]) => {
            if (list) {
