...
export class ItemGroupService {
  ...
  deleteItemGroup(itemGroupEntity: ItemGroupEntity, itemGroupSearchEntity: ItemGroupSearchEntity): Promise<void> {
    return new Promise((resolve, reject) => {
      return this.itemGroupRepository.deleteItemGroup(itemGroupEntity)
        .subscribe(
          () => {
            this.itemGroupRepository.getItemGroupsListFromLegal(itemGroupSearchEntity);
            resolve();
          },
          (error) => reject(error),
        );
