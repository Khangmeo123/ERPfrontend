...
import { LegalCustomerDetailEntity } from './legal-customer-detail.entity';

export class LegalCustomerDetailForm extends FormModel {
    ...
    constructor(supplierDetailEntity?: LegalCustomerDetailEntity) {
        super();
